...
class Ui_Lobby(object):
    def setupUi(self, Lobby):
        ...
        icon3 = QIcon()
        icon3.addFile(u":/icon/white/white_inbox.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/icon/white/white_hash.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_concept.setIcon(icon4)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/icon/white/white_feather.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_diary.setIcon(icon5)
