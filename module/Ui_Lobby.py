...
class Ui_Lobby(object):
    def setupUi(self, Lobby):
        ...
        icon5 = QIcon()
        icon5.addFile(u":/icon/white/white_bookmark.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionImport_Bookmarks.setIcon(icon5)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/icon/white/white_inbox.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_library.setIcon(icon6)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/icon/white/white_hash.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_concept.setIcon(icon7)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/icon/white/white_feather.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_diary.setIcon(icon8)
