...
class Ui_Lobby(object):
    def setupUi(self, Lobby):
        ...
        icon4 = QIcon()
        icon4.addFile(u":/icon/white/white_inbox.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/icon/white/white_hash.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_concept.setIcon(icon5)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/icon/white/white_feather.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_diary.setIcon(icon6)
