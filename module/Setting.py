...
class Setting(Ui_Setting,QStackedWidget):
	def __init__(self,Headquarter:LobbySession):
		...
		self.lineEdit_library_base.setText(Symmetric_Decrypt(self.Headquarter.password(),self.Headquarter.UserSetting().value("LibraryBase")))
	...
	def setLibraryBase(self):
		...
		if library_base:
			self.Headquarter.UserSetting().setValue("LibraryBase",Symmetric_Encrypt(self.Headquarter.password(),library_base))
			self.Headquarter.library_base=Symmetric_Decrypt(self.Headquarter.password(),self.Headquarter.UserSetting().value("LibraryBase"))
			self.lineEdit_library_base.setText(Symmetric_Decrypt(self.Headquarter.password(),self.Headquarter.UserSetting().value("LibraryBase")))
