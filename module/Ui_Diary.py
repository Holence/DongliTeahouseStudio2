...
class Ui_Diary(object):
    def setupUi(self, Diary):
        ...
        self.label_calendar = QLabel(self.widget)
        ...
        self.label_calendar.setMinimumSize(QSize(0, 30))
        self.label_calendar.setMaximumSize(QSize(16777215, 30))
